...
interface SearchActiveIconProps {
	className?: string,
	size?: number
}

const SearchActiveIcon: React.FC<SearchActiveIconProps> = ({
	className,
	size
}) => {
	return (
		<svg width={size} height={size} role="img" aria-hidden="true" viewBox="0 0 24 24" className={className} fill="white">
			<path
