interface VolumeOnPlayIconProps {
	onClick: () => void,
	className?: string,
	size?: number
}
const VolumeOnPlayIcon: React.FC<VolumeOnPlayIconProps> = ({
	onClick,
	className,
	size
}) => {
	return (
		<svg fill="currentColor" role="presentation" height={size} width={size} aria-hidden="true" aria-label="Volumen" id="volume-icon" viewBox="0 0 16 16" className={className} onClick={onClick}>
			<path
...
export default VolumeOnPlayIcon